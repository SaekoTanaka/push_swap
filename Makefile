...
CHECK_SRC = get_next_line/get_next_line.c checker_d.c checker_d1.c \
	checker_main.c stack.c stack1.c arg.c cmd.c \

P_S_SRC = push_swap_data.c sort_3.c sort_3_help.c pushswap_main.c sort.c \
